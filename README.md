...
`index.html` is the GitHub Pages landing page. It shows the project logo and links to archive sections. Add material as it is supplied. Do not invent history, lineage, ranks, quotes, school details, pattern names, or technique names.
