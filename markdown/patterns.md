...
Names below follow the Curriculum Progression draft, in order. Shared history for a group of Pattern Sets appears once above that group. Where a group has several Pattern Sets, only the names are listed under that history.
